<script>
var palabra="WER EINMAL LUGT DEM GLAUBT MAN NICHT UND WENN ER AUCH DIE WAHRHEIT SPRICHT";
var actual=0;	
var rpta="";
window.parent.carga();
...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Herr Ginger ist nicht sehr glücklich. Er ist in Gefahr, gehängt zu werden, wenn Sie ihm nicht helfen können, den Satz darunter zu finden. Sie haben 6 Chancen, bevor es zu spät wird!.</div>";
...
<div id="divcontenedor" style="float:left;font-size:36px;color:#fff;"></div>	
...
<audio id="myAudio3"><source src="media/m.oga" type="audio/ogg"></audio>
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('018',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('018',rpta)">Aufgabe erledigt!</button>
	</div>
