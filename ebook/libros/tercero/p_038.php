...
var arrverbs=[
	["Emily","fängt","einen","Thunfisch"],
	["Peter","spielt","gut","Fußball"],	
	["Das","Auto","ist","schwarz"],	
	["Party","in","der","Nacht"],
	["Der","Hund","springt","glücklich"],
	["Der","Computer","ist","ausgefallen"],
	["Das","Essen","wird","serviert"],
	["es","regnet","immer","noch"],
	["Mein","Hemd","ist","sauber"],
	["Mama","spricht","mit","Papa"]	
]
arrrptas=[];
...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Wenn Sie bereit sind, steigen Sie in das Flugzeug, suchen und erschießen Sie die Banditen. Aber sei dir bewusst, dass jeder Bandit einen Namen hat, also musst du sie erschießen, um eine Phrase zu bilden. Viel Glück, Pilot!</div>";
...
<body>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="pintarpta();parent.saveforlater('038',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="pintarpta();parent.taskdone('038',rpta)">Aufgabe erledigt!</button>
	</div>
</body>
