...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 24px verdana;text-align:center;padding:50px 10px;' id='' class='' >Here is your chance to become the famous writer you know you can be:  write the speeches of our handsome hero in this comic episode. Use your imagination and count a great history to the world!</div>";
...
<body>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_1" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_2" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_3" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_4" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_5" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_6" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_7" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="float:left;border:6px solid #000;height:25%;width:28%;margin:1% 1% 0% 0%;" >
		<div style="float:left;width:100%;height:40px;overflow:hidden;" id="" class="" ><textarea id="t_8" style="" class="textareas"  placeholder="Text here"></textarea></div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('014',rpta)">Save for later</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('014',rpta)">Task done!</button>
	</div>
</body>