...
<div style="float:left;text-align:justify;font-size:19px;padding:0px 10px 0px 70px;height:98%;" class='fontech'>
	<div style="float:left;width:100%;overflow:hidden;font-size:60px;font-weight:bold;color:#fff;text-shadow:-1px -1px 1px #000,1px 1px 1px #000,2px 2px 1px #000,3px 3px 1px #000;opacity:0.5" id="" class='fontspace'>Weltraum</div>
	<div style='float:left;text-align:justify;font-size:20px;padding:0px 50px;font-weight:bold;color:#ffa;' class='fontech' id='divspeech' ondblclick="cambio()">
		Oder einfach nur Weltraum, ist die Weite, die jenseits der Erde und zwischen Himmelskörpern existiert. Der Weltraum ist nicht vollständig leer - es ist ein hartes Vakuum, das eine geringe Teilchendichte, vorwiegend ein Plasma aus Wasserstoff und Helium, sowie elektromagnetische Strahlung, Magnetfelder, Neutrinos, Staub und kosmische Strahlung enthält. Die Grundtemperatur des Weltraums, die durch die Hintergrundstrahlung des Urknalls bestimmt wird, beträgt 2,7 Kelvin (–270,45 ° C; –454,81 ° F). [1] Das Plasma zwischen Galaxien macht etwa die Hälfte der baryonischen (gewöhnlichen) Materie im Universum aus; es hat eine Zahlendichte von weniger als einem Wasserstoffatom pro Kubikmeter und eine Temperatur von Millionen Kelvin. [2] Lokale Materiekonzentrationen haben sich zu Sternen und Galaxien verdichtet. Studien zeigen, dass 90% der Masse in den meisten Galaxien in einer unbekannten Form vorliegt, der sogenannten Dunklen Materie, die durch Gravitationskräfte, aber nicht durch elektromagnetische Kräfte mit anderer Materie interagiert. [3] [4] Beobachtungen legen nahe, dass der Großteil der Massenenergie im beobachtbaren Universum dunkle Energie ist, eine Art Vakuumenergie, die kaum verstanden wird. [5] [6] Der intergalaktische Raum nimmt den größten Teil des Universums ein, aber selbst Galaxien und Sternensysteme bestehen fast ausschließlich aus leerem Raum.
	</div>
</div>
