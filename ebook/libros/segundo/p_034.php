...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 100px);overflow:hidden;font:bold 36px verdana;text-align:center;padding:50px;' id='' class='' >Dibuja el mapa del Perú!</div>";
...
<body>
	<div style="float:left;width:100%;overflow:hidden;text-align:center;font-size:38px;font-weight:bold;padding:2%;" id="" class="fontech" >Mapa del Perú</div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="saveToFile();">Guardar para despues</button>
		<button id="btntd" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="saveToFile();parent.taskdone('034',rpta)">Tarea terminada!</button>
	</div>
	<audio id="myAudio1" loop><source src="media/ccc.mp3" ></audio>
</body>