...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Durch Drücken der Buchstaben a, s, d, f, g, h, j, k, l können Sie jede Musik erklingen lassen. Erstellen Sie ein Lied und schreiben Sie die Buchstaben in das Textfeld, damit Sie es hören können, wenn Sie die Wiedergabetaste drücken.</div>";
...
String.prototype.formatMoney = function(decPlaces, thouSeparator, decSeparator, currencySymbol) {
	...
	<body>
		<section id="wrap">
			...
			<section id="main">
				<div style="float:left;width:100%;overflow:hidden;" id="" class="" ><button style='font:32px verdana;width:45%;color:#f00;' onclick="reduce();refoco();" onblur="refoco()">Löschen</button></div>
		...
		<div style="float:left;width:100%;overflow:hidden;" id="" class="" ><button style='font:32px verdana;width:95%;' onclick="espacio();refoco();" onblur="refoco()">Leertaste</button></div>
		<div style="float:left;width:100%;overflow:hidden;padding:10px;" id="" class="" ><input type='text' id='txt' style='font:32px verdana;width:75%;' oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" placeholder="Schreiben Sie hier die Schlüssel zum Hören"  onblur="refoco()">&nbsp;<button onclick="playme()"  onblur="refoco()"  style='font:32px verdana;width:20%;'>Hören</button></div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="musica();parent.saveforlater('024',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="musica();parent.taskdone('024',rpta)">Aufgabe erledigt!</button>
	</div>
	</body>
<script>
