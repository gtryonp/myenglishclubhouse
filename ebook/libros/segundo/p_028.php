...
function instructions() {
	...
	data+="<div style='float:left;width:40%;overflow:hidden;font:bold 24px verdana;text-align:center;padding:5px 0px;' id='' class='' ><img class='imagenrotar'  src='libros/"+top.document.getElementById("ruta").value+"/media/i_028.png' /></div>";
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:10px 10px;' id='' class='' >Encuentra las palabras que SI se encuentran en el texto y arrastralas hacia la parte superior, dejando en la parte inferior las que NO estan</div>";
...
arr=shuffleArray(["homo sapiens","dialecto","mestizaje","linguistica","religiones","ortodoxas","idiomas","densidad","electricidad","ideologia","memoria","salud"]);
...
<body>
	<div style="float:left;width:100%;overflow:hidden;text-align:center;padding:10px;font-size:40px;font-weight:bold;text-shadow:3px 1px 1px #fff;" id="" class="" >PALABRAS DEL TEXTO!</div>
  ...
  <div id="second" class="container segundo" ondrop="drop(event)" ondragover="allowDrop(event)" style="float:left;border:1px solid;width:80%;height:35%;min-height:200px;padding:20px;background:url(media/wood1.jpg);overflow:auto;"></div>
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('028',rpta)">Guardar para despues</button>
		<button id="btntd" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('028',rpta)">Tarea terminada!</button>
	</div>
