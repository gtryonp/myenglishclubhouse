...
window.onload=function() {
	init();
	instructions();
  words = ['nacht', 'wald', 'baum', 'baren', 'sterne', 'eule','grillen','bootcamp','erkunden'];
...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Oh mein! Ich liebe die Bootcamps, sie werden besser, wenn du auch in der Nacht bleibst. Spielen Sie eine Buchstabensuppe und finden und markieren Sie das Ziehen der Wörter. Yohoo!</div>";
...
<div id='words'  style="float:left;width:30%;font-size:22px;overflow:auto;"></div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('022',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('022',rpta)">Aufgabe erledigt!</button>
	</div>
