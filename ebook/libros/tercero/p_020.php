...
arr=shuffleArray(["als","Dave","und","Nancy","zu","mir","nach","Hause","kamen","lud","ich","sie","zum","Mittagessen","ein"]);
...
<body>
	<div style="float:left;width:100%;overflow:hidden;text-align:center;padding:10px;font-size:40px;font-weight:bold;text-shadow:3px 1px 1px #fff;" id="" class="" >SCRABBLE-WÖRTER!</div>
  ...
  <div id="second" class="container segundo" ondrop="drop(event)" ondragover="allowDrop(event)" style="float:left;border:1px solid;width:80%;height:35%;min-height:200px;padding:20px;background:url(media/wood1.jpg);overflow:auto;"></div>
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('020',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('020',rpta)">Aufgabe erledigt!</button>
	</div>
