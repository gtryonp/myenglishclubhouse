...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Auf der linken Seite finden Sie historische Momente. Auf der rechten Seite finden Sie Zeiten. Ziehen Sie den roten Punkt jedes Augenblicks auf die Zeit, zu der Sie glauben, dass er dazu gehört.</div>";
...
<body>
	<div style="float:left;width:100%;overflow:hidden;padding:20px 0px;font:bold 40px verdana;text-align:center;color:#924C0B;text-shadow:-1px -1px 1px #000,1px 1px 1px #000,2px 2px 10px #924C0B;" id="" class="" >Verbinden Sie die Leitungen</div>
	...
	<div id="canvas" style="position:relative;">
		...
		<div id="div_01" class="ui-item left" 	title="Stonedge"	 				style="position:absolute;top:010px;left:1%;	background:url('media/hl_01.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_01" class="con_anchor c_right"></div></div>
		<div id="div_02" class="ui-item left" 	title="Tunatkamaun"	 			style="position:absolute;top:110px;left:1%;	background:url('media/hl_02.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_02" class="con_anchor c_right"></div></div>
		<div id="div_03" class="ui-item left" 	title="Confucius"	 				style="position:absolute;top:210px;left:1%;	background:url('media/hl_03.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_03" class="con_anchor c_right"></div></div>
		<div id="div_04" class="ui-item left" 	title="JesusCrist"	 			style="position:absolute;top:310px;left:1%;	background:url('media/hl_04.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_04" class="con_anchor c_right"></div></div>
		<div id="div_05" class="ui-item left" 	title="Roma fall"	 				style="position:absolute;top:410px;left:1%;	background:url('media/hl_05.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_05" class="con_anchor c_right"></div></div>
		<div id="div_06" class="ui-item left" 	title="America discovery"	style="position:absolute;top:510px;left:1%;	background:url('media/hl_06.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_06" class="con_anchor c_right"></div></div>
		<div id="div_07" class="ui-item left" 	title="French revolution"	style="position:absolute;top:610px;left:1%;	background:url('media/hl_07.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_07" class="con_anchor c_right"></div></div>
		<div id="div_08" class="ui-item left" 	title="combustion cars"		style="position:absolute;top:710px;left:1%;	background:url('media/hl_08.jpg') center center no-repeat;background-size:cover;">	<div id="div_drag_08" class="con_anchor c_right"></div></div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('030',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('030',rpta)">Aufgabe erledigt!</button>
	</div>
</body>
<script>
</script>