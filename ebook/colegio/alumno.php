...
<script type="text/javascript">
	...
	xr.send("modo=get&modoarchivo=alumno");
	}
...
<body>
	<div style="float:left;width:calc(100%);" class="divcaja">
		<div style="float:left;width:100%;overflow:hidden;text-align:right;" id="" class="divtitulo" ><button class="btontop" onclick="anade('tablaalumno')">+</button><button class="btontop" onclick="retira('tablaalumno',this)">-</button></div>
		<div style="float:left;width:100%;overflow:auto;height:100px;" id="divtablaalumno" class="" ></div>
	</div>
</body>
