...
<body>
	...
	<div style="float:left;padding:20px 0px;width:35%;" id="" class="" >&nbsp;</div>
	<div style="float:left;width:100%;padding:10px 0px;text-align:center;color:#000;font-size:70px;text-shadow:1px 1px 5px #ff0;" id="" class="fontech" >GEOGRAFIA</div>
	<div style="float:left;width:100%;padding:10px 0px;text-align:center;color:#000;font-size:50px;text-shadow:1px 1px 5px #ff0;" id="" class="" >Perú y el mundo</div>
	<div style="float:left;width:100%;padding:20px 0px;text-align:center;color:#000;font-size:40px;text-shadow:1px 1px 5px #ff0;" id="" class="" >&nbsp;</div>
