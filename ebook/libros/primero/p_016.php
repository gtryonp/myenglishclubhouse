...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 24px verdana;text-align:center;padding:50px 10px;' id='' class='' >well, well. Houston, we have a problem! Our landing tripulation drunk too much yohoo and they are too dizzy to land the navy on time. Find the apollo and put it perfectly horizontal. Have a good landing!.</div>";
...
function moverluna() {
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="hallarpta();parent.saveforlater('016',rpta)">Save for later</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="hallarpta();parent.taskdone('016',rpta)">Task done!</button>
	</div>
	</body>
</html>