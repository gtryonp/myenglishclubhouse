...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 24px verdana;text-align:center;padding:50px 10px;' id='' class='' >Busca en el cubo al planeta tierra y posicionalo adelante y en su posicion horizontal.</div>";
...
function moverluna() {
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="hallarpta();parent.saveforlater('008',rpta)">Guardar para despues</button>
		<button id="btntd" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="hallarpta();parent.taskdone('008',rpta)">Tarea terminada!</button>
	</div>
	</body>
</html>