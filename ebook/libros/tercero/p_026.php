...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Diese kleinen Schlingel fliehen aus ihren Häusern. Ziehen Sie alle Haustiere per Drag & Drop in ihre Häuser, aber seien Sie vorsichtig: Sie können von einem Ort zum anderen rennen, solange sie frei sind!.</div>";
...
<body>
	<div style="float:left;width:100%;font-size:60px;font-weight:bold;" id="" class="" >HAUSTIER BEKOMMEN! </div>
	<div style="float:left;width:100%;overflow:hidden;" id="" class="" >Diese kleinen Schlingel fliehen aus ihren Häusern. Hilf uns, ihre Häuser zu nehmen!</div>
	<div id="div_1" class="cage" ondrop="drop(this,event,'drag_1')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(200,100,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">PAPAGEI</div>
	<div id="div_2" class="cage" ondrop="drop(this,event,'drag_2')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(100,200,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">MAUS</div>
	<div id="div_3" class="cage" ondrop="drop(this,event,'drag_3')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(200,200,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">HUND</div>
	<div id="div_4" class="cage" ondrop="drop(this,event,'drag_4')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(100,100,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">KATZE</div>
	<div style="clear:both;"></div>
	<div id="div_5" class="cage" ondrop="drop(this,event,'drag_5')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(150,200,125,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">IGEL</div>
	<div id="div_6" class="cage" ondrop="drop(this,event,'drag_6')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(250,200,125,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">HASE</div>
	...
	<div id="div_8" class="cage" ondrop="drop(this,event,'drag_8')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(250,200,125,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 24px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;">FISCH</div>
	<div style="clear:both;"></div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('026',rpta)">Für später speichern</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('026',rpta)">Aufgabe erledigt!</button>
	</div>
