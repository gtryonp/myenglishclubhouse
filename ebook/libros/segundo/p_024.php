...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >reuna cada una de las razones de indicadores de poblacion.</div>";
...
function drop(cualdiv,ev,cual) {
  ...
  var data = ev.dataTransfer.getData("text");
	if(document.getElementById(data).id==cual)	{
		...
		// document.getElementById(data).style.height="160px";
		// document.getElementById(data).style.width="200px";
		
		document.getElementById(data).style.top=(cualdiv.offsetTop)+"px";
		document.getElementById(data).style.left=(cualdiv.offsetLeft)+"px";
...
<body>
	<div style="float:left;width:100%;font-size:60px;font-weight:bold;" id="" class="" >POBLACION </div>
	<div style="float:left;width:100%;overflow:hidden;" id="" class="" >Lleva el elemento inferior al elemento superior</div>
	<div id="div_1" class="cage" ondrop="drop(this,event,'drag_1')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(200,100,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">FECUNDIDAD</div>
	<div id="div_2" class="cage" ondrop="drop(this,event,'drag_2')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(100,200,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">EDAD</div>
	<div id="div_3" class="cage" ondrop="drop(this,event,'drag_3')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(200,200,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">SEXO</div>
	<div id="div_4" class="cage" ondrop="drop(this,event,'drag_4')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(100,100,155,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">MORBILIDAD</div>
	<div style="clear:both;"></div>
	<div id="div_5" class="cage" ondrop="drop(this,event,'drag_5')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(150,200,125,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">NATALIDAD</div>
	<div id="div_6" class="cage" ondrop="drop(this,event,'drag_6')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(250,200,125,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">MIGRACION</div>
	<div id="div_7" class="cage" ondrop="drop(this,event,'drag_7')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(250,100,175,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">ESP.VIDA</div>
	<div id="div_8" class="cage" ondrop="drop(this,event,'drag_8')" ondragover="allowDrop(event)" style="float:left;height:125px;width:12%;background:url('media/house.png') center center rgba(250,200,125,0.5);background-size: cover;padding:20px;margin:5px;display: flex;justify-content: center;align-items: center;font:bold 22px verdana;color:#000;text-shadow:-1px -1px 1px #fff,1px 1px 1px #fff;letter-spacing:-3px;">MORTALIDAD</div>
	<div style="clear:both;"></div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('024',rpta)">Guardar para despues</button>
		<button id="btntd" 	style="font:bold 38px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('024',rpta)">Tarea terminada!</button>
	</div>
