...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 100px);overflow:hidden;font:bold 36px verdana;text-align:center;padding:0px 50px;' id='' class='' >	Drag and drop (up and down) each day in the list until they get ordered. Start with Sunday</div>";
...
<body>
	<div style="float:left;width:100%;overflow:hidden;font-size:calc(32px + 1vw);text-align:center;padding:20px 0px;color:#ffa;" id="" class="" >Order the days of the week</div>
	
	<div style="float:left;width:100%;overflow:hidden;padding:10px;font-size:36px;color:#fff;" id="" class="" >Make Sunday first!</div>

	
	<table id="tabladow" class='fontech'>
		<tbody>
			<tr id="tr_5"><td>Friday		</td><td>Viernes		</td></tr>
			<tr id="tr_4"><td>Thursday	</td><td>Jueves			</td></tr>
			<tr id="tr_3"><td>Wednesday	</td><td>Miercoles	</td></tr>
			<tr id="tr_2"><td>Tuesday		</td><td>Martes			</td></tr>
			<tr id="tr_6"><td>Saturday	</td><td>Sabado			</td></tr>
			<tr id="tr_0"><td>Sunday		</td><td>Domingo		</td></tr>
			<tr id="tr_1"><td>Monday		</td><td>Lunes			</td></tr>
		</tbody>
	</table>
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="crearpta();parent.saveforlater('008',rpta)">Save for later</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="crearpta();parent.taskdone('008',rpta)">Task done!</button>
	</div>
