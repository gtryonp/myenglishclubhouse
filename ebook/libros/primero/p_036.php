...
function instructions() {
	...
	data+="<div style='float:left;width:calc(60% - 20px);overflow:hidden;font:bold 28px verdana;text-align:center;padding:50px 10px;' id='' class='' >Press the button and sing the song. Tou will have your first record!</div>";
...
<body>
	...
	<div style="float:left;width:calc(100% - 100px);height:400px;padding:50px;" id="" class="" >
		...
		<div style="float:left;width:100%;overflow:hidden;padding:10px 0px;" id="" class="" >
			<button id="start" 		onclick="toggleStartStop()" 	style="padding:5px 0px;color:#000;background:#fa0;width:calc(50% - 6px);" class="">START Recording</button>
			<button id="play" 		onclick="playtune()" 					style="padding:5px 0px;color:#000;background:#fa0;width:calc(25% - 6px);" class="">Play</button>
			<button id="restart" 	onclick="limpiar()" 					style="padding:5px 0px;color:#000;background:#fa0;width:calc(25% - 6px);" class="">Clear</button>
		</div>
	...
	<div style="position:absolute;right:10px;bottom:10px;float:left;width:100%;overflow:hidden;text-align:right;" id="" class="" >
		<button id="btnsl" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.saveforlater('036',rpta)">Save for later</button>
		<button id="btntd" 	style="font:bold 42px verdana;border-radius:10px;background:#FF9900;text-shadow:-1px -1px 3px #fff;box-shadow:-1px -1px 1px #fff;display:none" onclick="parent.taskdone('036',rpta)">Task done!</button>
	</div>
